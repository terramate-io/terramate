...
func migrateFlagAliases(parsedArgs *Spec) {
	// list
...
func handleRootVersionFlagAlone(p *Spec, c *CLI) bool {
	if p.VersionFlag {
...
func defaultRootFlagCheckers() []rootFlagCheckers[*Spec] {
	return []rootFlagCheckers[*Spec]{
