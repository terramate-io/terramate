...
func TestTerragruntIncludeAllDependents(t *testing.T) {
	t.Parallel()
...
func TestTerragruntOnlyAllDependents(t *testing.T) {
	t.Parallel()
...
func TestTerragruntIncludeDependencies(t *testing.T) {
	t.Parallel()
	...
	res := cli.Run("list", "--changed", "--include-dependencies")
	AssertRunResult(t, res, RunExpected{
		Stdout: nljoin("stack-a", "stack-b", "stack-c"),
	})
}

func TestTerragruntOnlyDependencies(t *testing.T) {
	t.Parallel()
	...
	res := cli.Run("list", "--changed", "--only-dependencies")
	AssertRunResult(t, res, RunExpected{
