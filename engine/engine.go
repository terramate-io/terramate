...
func (e *Engine) ComputeSelectedStacks(gitfilter GitFilter, tags filter.TagClause, outputFlags OutputsSharingOptions, target string, stackFilters cloud.StatusFilters) (config.List[*config.SortableStack], error) {
