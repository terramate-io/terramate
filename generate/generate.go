...
const generalHeader = "// TERRAMATE: GENERATED AUTOMATICALLY DO NOT EDIT"
...
func loadGeneratedCode(path string) ([]byte, error) {
	...
	const (
		v0Header = "// GENERATED BY TERRAMATE: DO NOT EDIT"
	)

	for _, header := range []string{generalHeader, v0Header} {
