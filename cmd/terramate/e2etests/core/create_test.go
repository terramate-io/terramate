...
func TestCreateFailsWithIncompatibleFlags(t *testing.T) {
	...
	t.Run("--all-terragrunt and path", func(t *testing.T) {
		test(t, "--all-terragrunt", "./stack")
	})
	...
	t.Run("--all-terragrunt and --id", func(t *testing.T) {
		test(t, "--all-terragrunt", "--id=test")
	})
	...
	t.Run("--all-terragrunt and --name", func(t *testing.T) {
		test(t, "--all-terragrunt", "--name=some-stack")
	})
	...
	t.Run("--all-terragrunt and --description", func(t *testing.T) {
		test(t, "--all-terragrunt", "--description=desc")
	})
	...
	t.Run("--all-terragrunt and --after", func(t *testing.T) {
		test(t, "--all-terragrunt", "--after=/test")
	})
	...
	t.Run("--all-terragrunt and --before", func(t *testing.T) {
		test(t, "--all-terragrunt", "--before=/test")
	})
	...
	t.Run("--all-terragrunt and --import", func(t *testing.T) {
		test(t, "--all-terragrunt", "--import=/test")
	})
	...
	t.Run("--all-terragrunt and --ignore-existing", func(t *testing.T) {
		test(t, "--all-terragrunt", "--ignore-existing")
	})
}
