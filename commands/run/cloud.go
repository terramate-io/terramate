...
func setGitlabCIMetadata(_ *engine.Engine, md *cloud.DeploymentMetadata, state *CloudRunState) {
...
// CloudSyncLogs synchronizes the logs of a command with the Terramate Cloud.
func CloudSyncLogs(logger *zerolog.Logger, e *engine.Engine, run engine.StackRun, state *CloudRunState, logs cloud.CommandLogs) {
