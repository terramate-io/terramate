...
func (se StackEntry) WriteConfig(cfg hcl.Config) {
	...
	se.DirEntry.CreateFile(config.Filename, out.String())
}
...
// ReadGeneratedTerraform will read code that was generated by Terramate for this stack
// using export_as_terraform blocks.
