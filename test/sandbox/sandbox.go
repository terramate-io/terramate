...
// CreateConfig will create a terrastack configuration file on the stack
// or replace the current config if there is one.
func (se StackEntry) CreateConfig(body string, args ...interface{}) {
	se.DirEntry.CreateFile(terrastack.ConfigFilename, body, args...)
}

// ReadGeneratedTf will read code that was generated by terrastack for this stack.
...
func (se StackEntry) ReadGeneratedTf() string {
	return string(se.DirEntry.ReadFile(terrastack.GeneratedTfFilename))
}
