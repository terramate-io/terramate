...
- [stack.after](stack.md#stackafter-setstringoptional)
- [stack.before](stack.md#stackbefore-setstringoptional)
...
[stack.tags](stack.md#stacktags-setstringoptional) for the correct definition
