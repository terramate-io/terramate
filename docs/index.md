...
hero:
  ...
  tagline: Terramate adds powerful capabilities such as code generation, stacks, orchestration, change detection, globals and more to Terraform.
  actions:
    - theme: brand
      text: Get Started
      link: /overview
